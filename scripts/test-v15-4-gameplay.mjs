...
for (const marker of ['APP_VERSION = "15.4.0"', 'RULES_VERSION = "11.0"']) {
...
const sql = read("RUN_THIS_IN_SUPABASE_FOR_V15_4.sql");
for (const marker of [
...
console.log("GeoStats v15.4 gameplay-integrity checks passed.");
