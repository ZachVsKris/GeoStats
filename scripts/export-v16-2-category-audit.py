...
def main() -> int:
    ...
    if args.release_version in {"16.2.2", "16.2.3"}:
        curation_rpc = "apply_v16_2_3_catalog_curation" if args.release_version == "16.2.3" else "apply_v16_2_2_catalog_curation"
    ...
    guard_rpc = {"16.2.1": "assert_v16_2_1_source_recovery", "16.2.2": "assert_v16_2_2_source_recovery", "16.2.3": "assert_v16_2_3_source_recovery"}[args.release_version]
