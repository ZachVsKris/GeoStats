  ...
  return <main className="shell standalonePage infoPage">
    ...
    <section className="panel infoPagePanel">
      ...
      <div className="infoDocument">
        ...
        <h2>Accounts</h2>
        <p>An account is required for Expert play, verified score saving, and leaderboard access. You are responsible for activity on your account. Usernames may be rejected or removed when they impersonate GeoStats, contain abusive language, or interfere with the service.</p>
        <h2>Fair play</h2>
        <p>Do not manipulate score submissions, interfere with other players, probe private administrative or QA functionality, or use automated traffic in a way that disrupts the service. GeoStats may remove invalid scores or restrict abusive access.</p>
        <h2>Source rights</h2>
