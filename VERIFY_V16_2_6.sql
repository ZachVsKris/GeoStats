...
with release as (
  ...
  union all select 'Admin Workbench release-disposition contract restored',case when exists(select 1 from information_schema.columns where table_schema='public' and table_name='category_review_workbench_v16_2' and column_name='release_disposition_v16_2_3') and exists(select 1 from information_schema.columns where table_schema='public' and table_name='category_review_workbench_v16_2' and column_name='release_disposition_reason_v16_2_3') then 'PASS' else 'FAIL' end,(select count(*)::text from information_schema.columns where table_schema='public' and table_name='category_review_workbench_v16_2' and column_name in ('release_disposition_v16_2_3','release_disposition_reason_v16_2_3'))
