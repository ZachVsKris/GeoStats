...
const WORKFLOWS: Record<string, string> = {
  ...
  automaticExpansion: `${REPO_ACTIONS}/import-v15-9-expansion.yml`,
    ...
    <>
      ...
      <section style={{ marginTop: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
          ...
          <a href={WORKFLOWS.automaticExpansion} target="_blank" rel="noreferrer" style={{ ...button, textDecoration: "none" }}>Run automatic v15.9.2 expansion ↗</a>
        </div>
          ...
          {data.sources.map((item) => {
            ...
            return (
              <article key={item.id} style={card}>
                ...
                ) : ["pewreligion", "faostatfbs", "unescoheritage", "smithsoniangvp", "usgs", "naturalearth"].includes(key) ? (
