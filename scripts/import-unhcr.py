...
PLAIN_DESCRIPTIONS = {
    ...
    "most-stateless-people": "People not legally recognized as citizens by any country; this is what 'stateless' means. Unlike refugees, they may never have crossed a border.",
...
SPECS: tuple[UnhcrSpec, ...] = (
    ...
    unhcr_rule("most-stateless-people", "Most people without citizenship in any country", "🪪", "population", "coa", ("stateless", "sta"), min_coverage=35),
