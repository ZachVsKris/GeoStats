...
def write_disallowed_series(writer, countries, item_code, item, element_code, element, unit):
    for country in countries[:80]:
        writer.writerow([
            country.numeric, country.name, item_code, item, element_code, element,
            2025, unit, 100, "A", "Official data", "",
        ])
...
def main() -> None:
    ...
    assert IMPORTER.category_title("Wheat", "Production", "t", "0111", "5510") == "Most wheat produced"
