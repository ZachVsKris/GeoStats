...
RULES: tuple[IndicatorRule, ...] = (
    ...
    rule("longest-average-land-border", "Longest average land border", "Average land border length per neighboring country, among countries with a land border.", "🧭", "kilometers per neighbor", "high", min_coverage=120, fun=96, value_type="rate"),
    ...
    rule("longest-land-border", "Longest total land border", "Combined length of all international land borders.", "🧱", "kilometers", "high", fun=94, value_type="total"),
    rule("longest-single-land-border", "Longest border with one neighboring country", "Total length of the country’s longest shared land border with one neighboring country.", "🗺️", "kilometers", "high", fun=96, value_type="total"),
    ...
    rule("largest-continuous-land-area", "Largest continuous land area", "Area of the country’s largest single connected land piece.", "🗺️", "square kilometers", "high", fun=91, value_type="total"),
    ...
    rule("most-mapped-river-length", "Longest river network", "Combined length of Natural Earth river lines inside the country.", "🏞️", "kilometers", "high", layer="rivers", fun=96, value_type="total"),
