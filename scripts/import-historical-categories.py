...
class UNMembershipImporter(WarehouseImporter):
    ...
    def __init__(self, warehouse: SupabaseWarehouse | None, *, dry_run: bool = False, input_path: str | None = None) -> None:
        ...
        self.http = HttpClient(timeout=120, retries=5, user_agent="GeoStats/16.2.2 historical importer")
    ...
    def discover(self) -> list[CandidateDefinition]:
        ...
        return [CandidateDefinition(
            ...
            metadata={
                ...
                "derivation_version": "geostats-v16.2.2-un-membership-v1",
            },
        )]
...
class ConstituteImporter(WarehouseImporter):
    ...
    def discover(self) -> list[CandidateDefinition]:
        rule = IndicatorRule(
            key="newest-current-constitution",
            title="Newest current constitution",
        ...
        return [CandidateDefinition(
            ...
            metadata={
                ...
                "derivation_version": "geostats-v16.2.2-constitute-v1",
    ...
    def category_id(self, candidate: CandidateDefinition) -> str:
        return "history:newest-current-constitution"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--source", choices=("all", "unmembership", "constitute"), default="all")
    ...
    for importer in importers:
        ...
        if result.get("categories_processed") != 1 or result.get("failures"):
