    ...
    return NextResponse.json(
      {
        error: migrationMissing
          ? "Run RUN_THIS_IN_SUPABASE_FOR_V16_2_2.sql before using the Category Review Workbench."
          : error.message,
