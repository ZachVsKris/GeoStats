    ...
    <>
      ...
      <section style={{ ...card, marginBottom: 16, borderColor: "rgba(185,244,90,.45)", background: "linear-gradient(135deg,rgba(38,78,50,.72),rgba(8,30,24,.8))" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
          <div><span className="kicker">v16.2.2 catalog recovery</span><h2 style={{ margin: "5px 0" }}>Review categories in the Workbench</h2><p style={{ margin: 0, opacity: .72 }}>One authoritative decision, permanent political/self-report and clarity flags, source values, overlaps, and keyboard review.</p></div>
        ...
        {!data.integrity.migrationApplied ? <p style={{ marginBottom: 0 }}>Apply the v14.4 Supabase installer to enable integrity and board-quality reporting.</p> : <>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(145px,1fr))", gap: 9, margin: "14px 0" }}>
            {[
              ...
              ["Audit pending", data.integrity.overview.audit_pending],
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 760 }}>
            <thead><tr>{["Source", "Categories", "Playable", "Verified", "Warnings", "Blocked", "Audit pending", "Last audit"].map((heading) => <th key={heading} style={{ textAlign: "left", padding: 8, borderBottom: "1px solid rgba(255,255,255,.12)" }}>{heading}</th>)}</tr></thead>
      ...
      <section style={{ marginTop: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
          ...
          <a href={WORKFLOWS.automaticExpansion} target="_blank" rel="noreferrer" style={{ ...button, textDecoration: "none" }}>Run v16.2.2 catalog recovery ↗</a>
        </div>
            ...
            return (
              <article key={item.id} style={card}>
                ...
                {key === "world-bank" || key === "worldbank" ? (
                  ...
                  <button style={mutedButton} disabled>Retired from active catalog</button>
                ) : key === "ilostat" ? (
                ...
                ) : ["pewreligion", "faostatfbs", "smithsoniangvp", "usgs", "naturalearth"].includes(key) ? (
                  <a href={WORKFLOWS.automaticExpansion} target="_blank" rel="noreferrer" style={{ ...button, display: "inline-block", textDecoration: "none" }}>Run v16.2 recovery ↗</a>
