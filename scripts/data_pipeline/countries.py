"""The 195-state universe used by GeoStats: 193 UN members plus Palestine and the Holy See."""

UN_COUNTRY_ISO3 = frozenset(
    """
...
def normalize_iso3(value: object) -> str | None:
    code = str(value or "").strip().upper()
    if code in WHO_ISO_ALIASES:
        code = WHO_ISO_ALIASES[code] or ""
    return code if code in UN_COUNTRY_ISO3 else None
