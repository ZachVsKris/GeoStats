...
function coverageFloor(_row: PlayableCategoryRow, _existing?: Category) {
  ...
  // Thirty reporting countries remains the universal minimum coverage floor.
  // Historical DATE questions separately bypass the winner-top-30 heuristic,
  // but they do not bypass coverage or ranking-completeness requirements.
  return 30;
}
