...
SPECS: tuple[TradeSpec, ...] = (
    ...
    trade_rule("most-spices-exported", "Largest spice exports", "🫙", ("09",), min_coverage=95),
            ...
            CandidateDefinition(
                ...
                metadata={
                    ...
                    "source_query": {
                        ...
                        # Keep API selector codes canonical; human labels live in separate fields.
                        "reporterCode": "",
                        "reporterSelection": "all reporters",
                        "flowCode": "X",
                        "partnerCode": "0",
                        "partner": "World",
