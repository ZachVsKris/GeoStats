...
const PLAYER_TITLE_REWRITES: Array<[RegExp, string]> = [
  ...
  [/^Highest terrestrial and marine protected areas$/i, "Largest protected share of land and sea"],
  [/^Highest share of land and sea protected$/i, "Largest protected share of land and sea"],
...
function boardDescription(row: PlayableCategoryRow, title: string, existing?: Category) {
  ...
  if (/^Largest protected share of land and sea$/i.test(title)) return "Share of each country’s terrestrial and marine area designated as protected.";
