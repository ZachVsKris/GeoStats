...
for (const token of ['APP_VERSION = "16.2.9"', 'RULES_VERSION = "16.2.9"', 'PLAYER_COPY_VERSION = "16.2.9.3"', 'PLAYABLE_CATALOG_CACHE_VERSION = "16.2.9.328"']) check(version.includes(token), `version constants missing ${token}`);
