...
for (const token of ['APP_VERSION = "16.3.1"', 'RULES_VERSION = "16.3.1"', 'PLAYER_COPY_VERSION = "16.3.1.2"', 'PLAYABLE_CATALOG_CACHE_VERSION = "16.3.1.306.2"', 'LEADERBOARD_RATING_VERSION = "hybrid-absolute-peer-bayesian-v2"']) check(version.includes(token), `current v16.3 version contract missing ${token}`);
