...
export default async function AuditPage(){
  ...
  return <main className="shell standalonePage infoPage">
    <header>
      <Brand linked />
      <div className="headerButtons infoHeaderNav"><a className="headerButtonLink" href="/daily">Play Daily</a><a className="headerButtonLink" href="/data">Data &amp; sources</a></div>
    </header>
