...
type CatalogMacroDomain = { macro_domain: string; categories: number; playable: number; approved: number; pending: number; excluded: number };
...
type Dashboard = {
  ...
  catalogBalance: { migrationApplied: boolean; rows: CatalogMacroDomain[] };
  generatorReachability: { migrationApplied: boolean; summary: GeneratorReachabilitySummary };
...
const WORKFLOWS: Record<string, string> = {
  ...
  automaticExpansion: `${REPO_ACTIONS}/rebuild-v16-2-7.yml`,
  integrity: `${REPO_ACTIONS}/audit-source-integrity.yml`,
  reachability: `${REPO_ACTIONS}/audit-generator-reachability.yml`,
    ...
    <>
      ...
      <section style={{ ...card, marginTop: 16 }}>
        ...
        {!data.diversity.migrationApplied ? (
          <div style={{ opacity: .72 }}>Run the v16.2.7 Supabase migration to enable category, country and reachability diagnostics.</div>
        ) : (
          <>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 10 }}>
      ...
      <section style={{ marginTop: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
          ...
          <a href={WORKFLOWS.automaticExpansion} target="_blank" rel="noreferrer" style={{ ...button, textDecoration: "none" }}>Run v16.2.7 catalog + generator rebuild ↗</a>
        </div>
            ...
            return (
              <article key={item.id} style={card}>
                ...
                {key === "world-bank" || key === "worldbank" ? (
                  ...
                  <a href={WORKFLOWS.automaticExpansion} target="_blank" rel="noreferrer" style={{ ...button, display: "inline-block", textDecoration: "none" }}>Run v16.2.7 recovery ↗</a>
