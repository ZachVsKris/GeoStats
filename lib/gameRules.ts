...
export const MAX_BOARD_WINNER_GLOBAL_RANK = 20;
...
export function strongestGlobalWinnerRankForCategory(_category: Category, coverage: number) {
  // v16.2.7: every category uses the same verified global Top-20 anchor rule,
  // including historical/date and defined-subset categories. The eligible
  // universe is handled by the catalog/import layer; the board rule itself is
