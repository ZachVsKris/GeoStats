...
assert.match(dailyTrioRulesText, /trioConceptConflict/);
assert.match(dailyTrioRulesText, /MAX_TRIO_DEMOGRAPHICS_CATEGORIES = 2/);
...
assert.match(dailyTrioRouteText, /rules_version !== RULES_VERSION/);
assert.match(dailyTrioRouteText, /encoded_board,rules_version/);
