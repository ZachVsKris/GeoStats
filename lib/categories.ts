...
const CURATED_EXTERNAL_CATEGORIES: Category[] = [
  ...
  warehouseExternal({ id: "unesco:CR.MOD.3", name: "Highest upper-secondary completion rate", shortName: "Upper-secondary completion", indicator: "CR.MOD.3", warehouseSourceIndicatorCode: "CR.MOD.3", icon: "🎓", unit: "%", family: "Education", direction: "high", description: "Upper-secondary completion rate", coverageFloor: 130, similarityGroup: "education-completion" }),
