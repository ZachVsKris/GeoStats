...
SPECS = [
 ("beer","Most beer consumed per person","🍺",("beer",),"kg",None),
 ("wine","Most wine consumed per person","🍷",("wine",),"kg",None),
 ("milk","Most milk consumed per person","🥛",("milk excluding butter",),"kg",None),
 ("cheese","Most cheese consumed per person","🧀",("cheese",),"kg",None),
 ("eggs","Most eggs consumed per person","🥚",("eggs",),"kg",None),
 ("beef","Most beef consumed per person","🥩",("bovine meat",),"kg",None),
 ("pork","Most pork consumed per person","🥓",("pigmeat",),"kg",None),
 ("poultry","Most poultry consumed per person","🍗",("poultry meat",),"kg",None),
 ("fish","Most fish consumed per person","🐟",("fish seafood",),"kg",None),
 ("rice","Most rice consumed per person","🍚",("rice and products",),"kg",None),
 ("potatoes","Most potatoes consumed per person","🥔",("potatoes and products",),"kg",None),
 ("sugar","Most sugar consumed per person","🍬",("sugar sweeteners",),"kg",None),
 ("vegetable-oil","Most vegetable oil consumed per person","🫒",("vegetable oils",),"kg",None),
 ("coffee","Most coffee supplied per person","☕",("coffee and products",),"kg",None),
 ("tea","Most tea supplied per person","🍵",("tea including mate",),"kg",None),
 ("wheat-products","Most wheat products consumed per person","🍞",("wheat and products",),"kg",None),
 ("maize","Most maize consumed per person","🌽",("maize and products",),"kg",None),
 ("bananas","Most bananas consumed per person","🍌",("bananas",),"kg",None),
 ("tomatoes","Most tomatoes consumed per person","🍅",("tomatoes and products",),"kg",None),
 ("onions","Most onions consumed per person","🧅",("onions",),"kg",None),
 ("fruit","Most fruit consumed per person","🍎",("fruits excluding wine",),"kg",None),
 ("vegetables","Most vegetables consumed per person","🥕",("vegetables",),"kg",None),
 ("meat","Most meat consumed per person","🍖",("meat",),"kg",None),
 ("dairy-products","Most dairy products consumed per person","🧀",(),"kg",(("milk excluding butter",),("butter ghee",))),
 ("pulses","Most pulses consumed per person","🫘",("pulses",),"kg",None),
...
class FoodBalanceImporter(WarehouseImporter):
    ...
    def __init__(self,warehouse,*,input_path=None,dry_run=False):
        super().__init__(warehouse,dry_run=dry_run); self.input_path=input_path; self.http=HttpClient(timeout=300,retries=5,user_agent='GeoStats/15.9 FBS importer'); self._parsed=None; self.download_url=None; self.release=None
    def parsed(self):
