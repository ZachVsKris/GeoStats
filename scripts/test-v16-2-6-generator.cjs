...
for (const t of ['recentCategoryExposure','generateAnchoredRoundFromLoadedCatalog','weightedAnchorSample','chooseSeededAnchoredCandidate','priorityScore','worldKnowledgeBucket']) check(puzzle.includes(t),`puzzle engine missing ${t}`);
