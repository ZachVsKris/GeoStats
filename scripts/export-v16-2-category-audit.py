...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--release-version",
        choices=("16.2.1", "16.2.2", "16.2.3", "16.2.4", "16.2.5", "16.2.6", "16.2.7"),
        default="16.2.7",
...
def main() -> int:
    ...
    if args.release_version in {"16.2.2", "16.2.3", "16.2.4", "16.2.5", "16.2.6", "16.2.7"}:
        curation_rpc = "apply_v16_2_6_catalog_curation" if args.release_version in {"16.2.6", "16.2.7"} else ("apply_v16_2_5_catalog_curation" if args.release_version == "16.2.5" else ("apply_v16_2_4_catalog_curation" if args.release_version == "16.2.4" else ("apply_v16_2_3_catalog_curation" if args.release_version == "16.2.3" else "apply_v16_2_2_catalog_curation")))
        warehouse._request("POST", f"rpc/{curation_rpc}", {})
        warehouse._request("POST", "rpc/refresh_measurement_types_v16_2_2", {})
    if args.release_version == "16.2.7":
        warehouse._request("POST", "rpc/apply_v16_2_7_legacy_reaudit", {})
        warehouse._request("POST", "rpc/apply_v16_2_7_exact_title_deduplication", {})
        warehouse._request("POST", "rpc/refresh_category_decision_provenance_v16_2_7", {})
    ...
    guard_rpc = {"16.2.1": "assert_v16_2_1_source_recovery", "16.2.2": "assert_v16_2_2_source_recovery", "16.2.3": "assert_v16_2_3_source_recovery", "16.2.4": "assert_v16_2_4_release", "16.2.5": "assert_v16_2_5_release", "16.2.6": "assert_v16_2_6_release", "16.2.7": "assert_v16_2_7_release"}[args.release_version]
    # Pre-promotion v16.2.7 audit intentionally runs before the production-solver
    # reachability table is populated. The final export must pass the strict gate.
    if not (args.release_version == "16.2.7" and args.phase == "pre"):
