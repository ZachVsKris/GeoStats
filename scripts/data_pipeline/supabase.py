...
class SupabaseWarehouse:
    ...
    def finalize_v16_catalog(self, *, release_version: str = "16.2.5") -> Any:
        ...
        if release_version not in {"16.2.1", "16.2.2", "16.2.3", "16.2.4", "16.2.5"}:
            raise ValueError(f"Unsupported guarded catalog release: {release_version}")
        guard = ({"16.2.1": "assert_v16_2_1_source_recovery", "16.2.2": "assert_v16_2_2_source_recovery", "16.2.3": "assert_v16_2_3_source_recovery", "16.2.4": "assert_v16_2_4_release", "16.2.5": "assert_v16_2_5_release"})[release_version]
