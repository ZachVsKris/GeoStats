...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--release-version",
        choices=("16.2.1", "16.2.2", "16.2.3", "16.2.4", "16.2.5"),
        default="16.2.5",
...
def main() -> int:
    ...
    if args.release_version in {"16.2.2", "16.2.3", "16.2.4", "16.2.5"}:
        curation_rpc = "apply_v16_2_5_catalog_curation" if args.release_version == "16.2.5" else ("apply_v16_2_4_catalog_curation" if args.release_version == "16.2.4" else ("apply_v16_2_3_catalog_curation" if args.release_version == "16.2.3" else "apply_v16_2_2_catalog_curation"))
    ...
    guard_rpc = {"16.2.1": "assert_v16_2_1_source_recovery", "16.2.2": "assert_v16_2_2_source_recovery", "16.2.3": "assert_v16_2_3_source_recovery", "16.2.4": "assert_v16_2_4_release", "16.2.5": "assert_v16_2_5_release"}[args.release_version]
