...
const RAW_CATEGORIES: Category[] = [
  ...
  wb({id:"infantMortality",name:"Lowest infant mortality",shortName:"Infant mortality",indicator:"SP.DYN.IMRT.IN",icon:"🩺",unit:"per 1,000",family:"Health",direction:"low",description:"Deaths before age one per 1,000 live births",decimals:1}),
  ...
  wb({id:"gdpPc",name:"Highest GDP per person",shortName:"GDP per person",indicator:"NY.GDP.PCAP.CD",icon:"💵",unit:"USD/person",family:"Economy",direction:"high",description:"The country’s total economic output divided by its population"}),
  ...
  wb({id:"agValue",name:"Largest agricultural output",shortName:"Agriculture output",indicator:"NV.AGR.TOTL.CD",icon:"🚜",unit:"USD",family:"Agriculture",direction:"high",description:"Value created by agriculture, forestry and fishing during the year"}),
  ...
  wb({id:"agLand",name:"Highest % of land used for agriculture",shortName:"Agricultural land",indicator:"AG.LND.AGRI.ZS",icon:"🌾",unit:"%",family:"Agriculture",direction:"high",description:"Percent of land area used for agriculture",decimals:1}),
  wb({id:"arablePct",name:"Highest % of land that is arable",shortName:"Arable land",indicator:"AG.LND.ARBL.ZS",icon:"🌱",unit:"%",family:"Agriculture",direction:"high",description:"Percent of land area that is arable",decimals:1}),
  wb({id:"arableHa",name:"Most arable land",shortName:"Arable land",indicator:"AG.LND.ARBL.HA",icon:"🧑‍🌾",unit:"hectares",family:"Agriculture",direction:"high",description:"Land suitable for temporary crops or pasture, measured in hectares"}),
  ...
  wb({id:"airPassengers",name:"Most passengers carried by airlines based in the country",shortName:"Air passengers",indicator:"IS.AIR.PSGR",icon:"✈️",unit:"passengers",family:"Transport",direction:"high",description:"Domestic and international passengers carried by airlines based in each country"}),
  ...
  wb({id:"freshwater",name:"Most renewable freshwater",shortName:"Freshwater resources",indicator:"ER.H2O.INTR.K3",icon:"💧",unit:"billion m³",family:"Environment",direction:"high",description:"Fresh water naturally replenished by rainfall, rivers and groundwater each year",decimals:1}),
  ...
  wb({id:"education",name:"Highest education spending as % of GDP",shortName:"Education spending",indicator:"SE.XPD.TOTL.GD.ZS",icon:"🎓",unit:"% of GDP",family:"Education",direction:"high",description:"Government education spending as a percentage of the country’s total economic output",decimals:2}),
  ...
  wb({id:"foodExportsShare",name:"Highest % of goods exports that are food",shortName:"Food exports",indicator:"TX.VAL.FOOD.ZS.UN",icon:"🍎",unit:"% of merchandise exports",family:"Trade",direction:"high",description:"Food, percent of merchandise exports",decimals:1,expectedRange:[0,100]}),
  wb({id:"foodImportsShare",name:"Highest % of goods imports that are food",shortName:"Food imports",indicator:"TM.VAL.FOOD.ZS.UN",icon:"🥫",unit:"% of merchandise imports",family:"Trade",direction:"high",description:"Food, percent of merchandise imports",decimals:1,expectedRange:[0,100]}),
  wb({id:"merchExports",name:"Largest goods exports recorded by customs",shortName:"Customs goods exports",indicator:"TX.VAL.MRCH.CD.WT",icon:"🚢",unit:"USD",family:"Trade",direction:"high",description:"Physical products exported across national borders as recorded by customs"}),
  wb({id:"highTechExports",name:"Largest advanced technology exports",shortName:"Advanced technology exports",indicator:"TX.VAL.TECH.CD",icon:"🛰️",unit:"USD",family:"Trade",direction:"high",description:"Aerospace, computers, electronics, pharmaceuticals and scientific instruments, current US dollars"}),
  ...
  wb({id:"militarySpend",name:"Largest military spending",shortName:"Military spending",indicator:"MS.MIL.XPND.CD",icon:"🛡️",unit:"USD",family:"Government",direction:"high",description:"Total military spending in current US dollars"}),
  ...
  wb({id:"healthSpendShare",name:"Highest health spending as % of GDP",shortName:"Health spending % GDP",indicator:"SH.XPD.CHEX.GD.ZS",icon:"⚕️",unit:"% of GDP",family:"Health",direction:"high",description:"Current health spending as a percentage of the country’s total economic output",decimals:1,expectedRange:[0,30]}),
  ...
  wb({id:"exportsShare",name:"Highest exports as % of GDP",shortName:"Exports % GDP",indicator:"NE.EXP.GNFS.ZS",icon:"📤",unit:"% of GDP",family:"Economy",direction:"high",description:"Goods and services exports, percent of GDP",decimals:1}),
  ...
  wb({id:"merchImports",name:"Largest goods imports recorded by customs",shortName:"Customs goods imports",indicator:"TM.VAL.MRCH.CD.WT",icon:"📥",unit:"USD",family:"Trade",direction:"high",description:"Physical products imported across national borders as recorded by customs"}),
  wb({id:"fixedBroadband",name:"Highest fixed broadband subscriptions per 100 people",shortName:"Fixed broadband",indicator:"IT.NET.BBND.P2",icon:"🛜",unit:"per 100 people",family:"Technology",direction:"high",description:"Fixed broadband subscriptions for every 100 people",decimals:1}),
  ...
  wb({id:"militaryShare",name:"Highest military spending as % of GDP",shortName:"Military spending % GDP",indicator:"MS.MIL.XPND.GD.ZS",icon:"🪖",unit:"% of GDP",family:"Government",direction:"high",description:"Military spending as a percentage of the country’s total economic output",decimals:2}),
