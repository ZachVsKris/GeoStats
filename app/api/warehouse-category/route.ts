...
const ALLOWED_CATEGORY_ID =
  /^(worldbank-catalog|worldbank-expansion|faostat|faostat-fbs|who|unesco|unescoheritage|ilostat|naturalearth|comtrade|eia|unhcr|pew-religion|smithsoniangvp|usgs|worldcover|hydrosheds|elevation):[a-z0-9:._-]+$/;
