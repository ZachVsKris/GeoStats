...
export const SOURCE_REGISTRY: Record<DataSourceId, SourceDefinition> = {
  ...
  worldcover: {
    ...
    verifier: "scripts/test-physical-summary-importer.py",
    playable: true,
  ...
  unescoheritage: {
    ...
    homepage: "https://whc.unesco.org/en/list/", verifier: "scripts/test-unesco-world-heritage-importer.py", playable: true,
  },
  aquastat: {
