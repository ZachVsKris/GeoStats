...
export default function CategoryReviewWorkbench() {
  ...
  return <section className="reviewWorkbench">
    ...
    <div className="reviewToolbar">
      ...
      <select value={promotion} onChange={(event) => { setPromotion(event.target.value as PromotionFilter); setPage(1); }} aria-label="Filter by v16.2 outcome">
        <option value="all">Any v16.2 outcome</option>
          ...
          <div className="reviewDetailGrid">
            ...
            <section className="reviewPanel">
              ...
              <div className={current.computed_playable_v16_2 ? "reviewPass" : "reviewBlockerList"}>
                ...
                <span>{current.primary_blocker_v16_2 ?? current.promotion_reason_v16_2 ?? "Passes all v16.2 gameplay gates."}</span>
