...
PLAIN_DESCRIPTIONS = {
    ...
    "most-stateless-people": "Number of stateless people reported as living in each country.",
...
SPECS: tuple[UnhcrSpec, ...] = (
    ...
    unhcr_rule("most-stateless-people", "Largest stateless population residing in the country", "🪪", "population", "coa", ("stateless", "sta"), min_coverage=35),
