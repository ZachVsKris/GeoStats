...
RULES: tuple[IndicatorRule, ...] = (
    ...
    rule("highest-clean-fuel-access", "Highest clean-cooking-fuel access", "Infrastructure", "🔥", "% of population", "percentage", "high", (r"primary reliance on clean fuels|clean fuels and technologies for cooking",), exclude=(r"urban|rural|female|male",), min_coverage=150, evidence="B", modeled=0.8),
