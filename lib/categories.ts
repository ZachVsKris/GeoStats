...
const RAW_CATEGORIES: Category[] = [
  ...
  wb({id:"education",name:"Highest education spending as % of GDP",shortName:"Education spending",indicator:"SE.XPD.TOTL.GD.ZS",icon:"🎓",unit:"% of GDP",family:"Education",direction:"high",description:"Government education spending, percent of GDP",decimals:2}),
  ...
  wb({id:"healthSpendShare",name:"Highest health spending as % of GDP",shortName:"Health spending % GDP",indicator:"SH.XPD.CHEX.GD.ZS",icon:"⚕️",unit:"% of GDP",family:"Health",direction:"high",description:"Current health spending, percent of GDP",decimals:1,expectedRange:[0,30]}),
