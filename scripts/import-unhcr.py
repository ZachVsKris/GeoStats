...
PLAIN_DESCRIPTIONS = {
    ...
    "most-stateless-people": "People living in the country who are not legally recognized as citizens by any country. Unlike refugees, stateless people may never have crossed a border.",
...
SPECS: tuple[UnhcrSpec, ...] = (
    ...
    unhcr_rule("most-stateless-people", "Most stateless people living in the country", "🪪", "population", "coa", ("stateless", "sta"), min_coverage=35),
