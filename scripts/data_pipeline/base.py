...
class WarehouseImporter(ABC):
    ...
    def build_category_row(self, candidate, quality, governance, category_id: str) -> dict[str, object]:
        ...
        manual_review_required = (
            self.source_slug in V15_8_MANUAL_REVIEW_SOURCES
        ...
        return {
            ...
            "metadata": {
                **candidate.metadata,
                ...
                "expansion_intake_version": "v15.8" if manual_review_required else candidate.metadata.get("expansion_intake_version"),
