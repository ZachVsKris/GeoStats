...
# Shape/position span concepts that were distorted by overseas-territory unions are retired.
retired = {
    "largest-geographic-span", "largest-north-south-span", "largest-east-west-span",
    "northernmost-country", "southernmost-country", "farthest-from-equator",
    "most-separate-land-areas", "most-large-land-areas",
}
