...
export const alt = "GeoStats — A world of facts. One perfect fit.";
...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 84, background: "#08130f", color: "#eee9d9", border: "18px solid #0f2019" }}>
      ...
      <div style={{ display: "flex", marginTop: 22, color: "#a9ad9f", fontSize: 42 }}>A world of facts. One perfect fit.</div>
